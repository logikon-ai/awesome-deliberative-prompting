...
* 🎓 Deliberative prompting is highly effective for OpenAI's models (Text-Davinci-003, ChatGPT, GPT-4), increasing accuracy in many reasoning tasks in the EvalAGI benchmark. "AGIEval: A Human-Centric Benchmark for
